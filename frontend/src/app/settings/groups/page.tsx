    ...
    <div className="p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-black mt-0.5">Manage user groups and team-based access control</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-gray-300 shadow-sm p-16 text-center">
        ...
        <p className="text-sm text-black max-w-md mx-auto mb-6">
          Create user groups to manage team-based access to specific Control Towers, accounts, and cost reports.
        </p>
        <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto text-left">
          {["Create user groups","Assign users to groups","Group-based CT access","Group-based report access","Group cost allocation","Audit by group"].map((f) => (
