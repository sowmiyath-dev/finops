    ...
    <div className="p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-black mt-0.5">Cost threshold alerts and anomaly notifications</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-gray-300 shadow-sm p-16 text-center">
        ...
        <p className="text-sm text-black max-w-md mx-auto mb-6">
          Set up cost threshold alerts, anomaly detection, and budget notifications across all cloud providers.
        </p>
        <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto text-left">
          {["Budget threshold alerts","Cost spike detection","Daily spend alerts","Email notifications","Slack integration","Multi-cloud alerts"].map((f) => (
