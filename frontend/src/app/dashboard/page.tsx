...
import {
  Plus, RefreshCw, Trash2, ChevronRight, Clock,
  Building2, Users, DollarSign, AlertCircle, CheckCircle,
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  const autoSyncMutation = useMutation({
    ...
    onSuccess: () => { toast.success("Updated"); qc.invalidateQueries({ queryKey: ["towers"] }); },
  });
    ...
    <div className="min-h-screen" style={{ background: "#f1f4f9" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-black">Control Towers</h1>
        ...
        {/* Boundary notice */}
        {boundary && (
          <div className="flex items-center gap-2 mb-6 px-4 py-3 rounded-lg border border-blue-300 bg-blue-50 text-blue-900 text-sm font-semibold">
        ...
        {towers.length > 0 && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              ...
              { label: "Total Accounts", value: totalAccounts, color: "#ec7211" },
            ].map((c) => (
