...
import {
  Layers, Users, Box, DollarSign, ChevronRight, Plus, Trash2, X, ChevronLeft,
} from "lucide-react";
import {
...
export default function VerticalDetailPage() {
  ...
  // Merge trend data across all owners for the stacked chart
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-black">{owners.length} owners · {costData.reduce((s, o) => s + o.app_count, 0)} applications</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          { label: "Applications", value: costData.reduce((s, o) => s + o.app_count, 0), icon: Box },
        ].map((k) => (
      ...
      <div className="bg-white rounded-lg border border-gray-300 shadow-sm">
        ...
        {owners.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="text-xs text-black mt-1">Add an owner to start grouping applications</p>
          </div>
        ) : (
          <table className="w-full">
            ...
            <tbody>
              {owners.map((owner) => {
                const cd = costData.find((c) => c.owner_id === owner.id);
                return (
